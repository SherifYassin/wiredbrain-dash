...
export class RewardServiceProvider {
  ...
  constructor(private storage: Storage, public modalCntrl: ModalController) {
    console.log('Hello RewardServiceProvider Provider');
  }

  rewards: any[] = [];
  list: any[] = [0.50, 0.75, 1.00, 1.25, 1.50, 1.75, 2.00, 0.25, 0.50, 0.75, 1.00];
  ...
  displayReward(amount){
    let theModal = this.modalCntrl.create(RewardModalPage, {'rewardParam': amount});
    theModal.present();
  }
}
